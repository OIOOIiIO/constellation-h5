...
preloadimages(['/img/con-img-zipped/p01.jpg','/img/con-img-zipped/p02.jpg','/img/con-img-zipped/p03.jpg',
'/img/con-img-zipped/p04.jpg','/img/con-img-zipped/p05.jpg','/img/con-img-zipped/p06.jpg','/img/con-img-zipped/p07.jpg',
'/img/con-img-zipped/p08.jpg','/img/con-img-zipped/p09.jpg','/img/con-img-zipped/p10.jpg','/img/con-img-zipped/p11.jpg',
'/img/con-img-zipped/p12.jpg','/img/con-img-zipped/p13.jpg','/img/con-img-zipped/p14.jpg','/img/con-img-zipped/p15.jpg',
'/img/con-img-zipped/p16.jpg','/img/con-img-zipped/p17.jpg','/img/con-img-zipped/p18.jpg','/img/con-img-zipped/p19.jpg',
'/img/con-img-zipped/p20.jpg','/img/con-img-zipped/p21.jpg','/img/con-img-zipped/p22.jpg','/img/con-img-zipped/p23.jpg',
'/img/con-img-zipped/p24.jpg','/img/con-img-zipped/p25.jpg','/img/con-img-zipped/p26.jpg','/img/con-img-zipped/p27.jpg',
'/img/con-img-zipped/p28.jpg','/img/1.png','/img/2.png','/img/3.png','/img/4.png',
]);
...
var identity1 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p01.jpg');")
...
var identity2 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p02.jpg');")
...
var identity3 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p03.jpg');")
...
var identity4 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p04.jpg');")
...
var identity5 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p05.jpg');")
...
var identity6 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p06.jpg');")
...
var identity7 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p07.jpg');")
...
var identity8 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p08.jpg');")
...
var identity9 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p09.jpg');")
...
var identity10 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p10.jpg');")
...
var identity11 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p11.jpg');")
...
var identity12 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p12.jpg');")
...
var identity13 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p13.jpg');")
...
var identity14 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p14.jpg');")
...
var identity15 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p15.jpg');")
...
var identity16 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p16.jpg');")
...
var identity17 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p17.jpg');")
...
var identity18 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p18.jpg');")
...
var identity19 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p19.jpg');")
...
var identity20 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p20.jpg');")
...
var identity21 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p21.jpg');")
...
var identity22 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p22.jpg');")
...
var identity23 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p23.jpg');")
...
var identity24 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p24.jpg');")
...
var identity25 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p25.jpg');")
...
var identity26 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p26.jpg');")
...
var identity27 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p27.jpg');")
...
var identity28 = function(){
  document.getElementById('main-pic').setAttribute('style',"background-image: url('/img/con-img-zipped/p28.jpg');")
...
var Option = function(){
    ...
    document.getElementById('option-3-A').addEventListener('click',function(){
      ...
      document.getElementById('option-4-A').addEventListener('click',function(){
        ...
        document.getElementById('option-6-A').addEventListener('click',function(){
          ...
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p02.jpg');")
        ...
        document.getElementById('option-6-B').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p21.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity21();
        });
        document.getElementById('option-6-C').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p24.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity24();
        });
        document.getElementById('option-6-D').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p11.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity11();
        });
      ...
      document.getElementById('option-4-B').addEventListener('click',function(){
        ...
        document.getElementById('option-7-B').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p03.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity3();
        });
        document.getElementById('option-7-A').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p01.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity1();
        });
        document.getElementById('option-7-C').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p25.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity25();
        });
        document.getElementById('option-7-D').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p07.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity7();
        });
      ...
      document.getElementById('option-4-C').addEventListener('click',function(){
        ...
        document.getElementById('option-8-C').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p08.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity8();
        });
        document.getElementById('option-8-A').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p16.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity16();
        });
        document.getElementById('option-8-B').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p04.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity4();
        });
        document.getElementById('option-8-D').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p22.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity22();
        });
      ...
      document.getElementById('option-4-D').addEventListener('click',function(){
        ...
        document.getElementById('option-9-D').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p12.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity12();
        });
        document.getElementById('option-9-A').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p15.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity15();
        });
        document.getElementById('option-9-B').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p09.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity9();
        });
        document.getElementById('option-9-C').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p13.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity13();
        });
    ...
    document.getElementById('option-3-B').addEventListener('click',function(){
      ...
      document.getElementById('option-5-B').addEventListener('click',function(){
        ...
        document.getElementById('option-10-A').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p14.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity14();
        });
        document.getElementById('option-10-B').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p10.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity10();
        });
        document.getElementById('option-10-C').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p06.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity6();
        });
        document.getElementById('option-10-D').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p18.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity18();
        });
      ...
      document.getElementById('option-5-C').addEventListener('click',function(){
        ...
        document.getElementById('option-11-A').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p17.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity17();
        });
        document.getElementById('option-11-B').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p05.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity5();
        });
        document.getElementById('option-11-C').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p19.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity19();
        });
        document.getElementById('option-11-D').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p23.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity23();
        });
      ...
      document.getElementById('option-5-D').addEventListener('click',function(){
        ...
        document.getElementById('option-12-A').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p26.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity26();
        });
        document.getElementById('option-12-B').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p20.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity20();
        });
        document.getElementById('option-12-C').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p27.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity27();
        });
        document.getElementById('option-12-D').addEventListener('click',function(){
          ...
          document.getElementById('subject').setAttribute('style','visibility: hidden;')
          document.getElementById('constellation-img').setAttribute('style',"background-image: url('/img/con-img-zipped/p28.jpg');")
          document.getElementById('constellation-img').classList.add('constellation-show');
          document.getElementById('creat-button').setAttribute('style','visibility: visible;');
          identity28();
        });
  ...
  var optionOne = function(){
    ...
    document.getElementById('subject').innerHTML = "<span id='que'>选择一个你喜欢的图形?</span><table class='option'><tbody><tr><td class='option-2' id='option-2-A' style='width:25%'><img src='/img/1.png'></td><td class='option-2' id='option-2-B' style='width:25%'><img src='/img/2.png'></td><td class='option-2' id='option-2-C' style='width:25%'><img src='/img/3.png'></td><td class='option-2' id='option-2-D' style='width:25%'><img src='/img/4.png'></td></tr></tbody></table>";
